...
export const properties: INodeProperties[] = [
	{
		...
		displayOptions: { show: { resource: ['receita_federal'], operation: ['serpro_dv_face_tarifado_v4'] } },
	},
	{
...
export async function execute(this: IExecuteFunctions, i: number) {
	const parametros: IDataObject = {
		...
		'ORGAO_EXPEDIDOR_DOCUMENTO_ORIGEM': this.getNodeParameter('orgaoExpedidorDocumentoOrigem', i) as string,
	...
	return await rocketApiExecuteProvider.call(this, i, 'serpro_dv_face_tarifado_v4', parametros);
}
