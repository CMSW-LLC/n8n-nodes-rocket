...
const operations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				value: 'processos_cnj',
				action: 'Conselho nacional de justica',
			},
			{
				name: 'CNJ - Conselho Nacional De Justica - Consulta Publica Processos',
				value: 'cnj_processos',
				action: 'Conselho nacional de justica consulta publica processos',
			},
			{
			...
			},
			{
				...
				value: 'stf',
				action: 'Supremo tribunal federal',
			},
			{
				name: 'STJ - Superior Tribunal De Justica',
				value: 'stj',
				action: 'Superior tribunal de justica',
			},
			{
				name: 'TRF 1 Regiao',
				value: 'trf_1',
